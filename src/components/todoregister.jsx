...
export function ToDoRegister(){
    ...
    return(
            ...
            <form onSubmit={formik.handleSubmit} className='bg-light p-4 m-3 border
            border-2 border-dark rounded w-25'>
                <div className='bi h5 bi-person-fill'>Register User</div>
                <dl>
                    <dt>UserId</dt>
                    <dd><input type="text" onKeyUp={VerifyUserId} name="UserId" 
                    ...
                    onChange={formik.handleChange} className='form-control'/></dd>
                    <dt>Email</dt>
                    <dd><input type='email' name='Email' onChange={formik.handleChange}
                    className='form-control'/></dd>
                    <dt>Mobile</dt>
